...
<script type="text/javascript">
	function allowForm(){
		...
		document.getElementById('inputFiledp').innerHTML = '<input type="file" name="image" id="myfile" required>';
...
<?php
	...
	if (isset($_POST['updateProfile'])) {
		...
		if($allow == "yes"){
			...
			$update = "UPDATE users_tbl SET username = '$username', phonenumber = '$phonenumber', profilePicture = '$imageName' WHERE userID = '$user_id'";
			...
			$update = "UPDATE users_tbl SET username = '$username', phonenumber = '$phonenumber' WHERE userID = '$user_id'";
			$query = mysqli_query($con,$update);
...
<?php
	...
	if (isset($_POST['updatepass'])) {
		...
		if($oldpass == $passwordCurrent){
			...
			$update = "UPDATE users_tbl SET password = '$newpass'WHERE userID = '$user_id'";
			$query = mysqli_query($con,$update);
